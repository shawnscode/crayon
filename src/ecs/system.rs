...
// use ecs::world::World;
// use ecs::view::{Fetch, FetchMut, View};
...
//         self.run(View::new(world, mask), Self::ViewWith::fetch(world))
//     }
// }
...
//         let mask = Self::mask_at(world);
//         self.run_mut(View::new(world, mask), Self::ViewWithMut::fetch_mut(world))
//     }
...
//         mask.insert(world.mask_index::<T>());
//         mask
//     }
