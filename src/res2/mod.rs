...
impl ResourceSystemShared {
    ...
    /// Loads a resource at location asynchronously.
    pub fn load<T: Loader>(&self, loader: T, uuid: Uuid) -> Result<Arc<Promise>> {
    ...
    pub fn wait_until(&self, promise: Arc<Promise>) -> Result<()> {
